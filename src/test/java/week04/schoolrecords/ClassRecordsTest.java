...
public class ClassRecordsTest {
    ...
    public void setUp() {
        ...
        secondStudent.grading(new Mark(MarkType.D, new Subject("földrajz"), tutor));  //zene volt
    ...
    public void testCalculateClassAverageBySubject() {
        ...
        //Then
        assertEquals(2.75, classRecords.calculateClassAverageBySubject(geography));  //sztem ez 3.0
    }
