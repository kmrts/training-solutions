...
public class SimpleDateTest {
    ...
    @Test
    public void alsoNotLeapYear() throws IllegalArgumentException {
        SimpleDate sd = new SimpleDate();

        Exception ex = assertThrows(IllegalArgumentException.class, () -> {
            sd.setDate(1900, 02, 29);
        });

        assertEquals("One or more given parameter cannot be applied! 1900, 2, 29", ex.getMessage());
    }
}